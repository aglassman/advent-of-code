...
aoc 2022, 11 do
  ...
  def throw(monkeys, times, worry_calc) do
    monkeys =
      for id <- 0..(Map.size(monkeys) - 1), reduce: monkeys do
        monkeys ->
  ...
  def print_inspected(monkey),
    do: "Monkey #{monkey[:id]} inspected items #{monkey[:inspected]} times."
end
